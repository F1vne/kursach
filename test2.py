...
my_game.column("player_id",anchor=CENTER, width=30)
my_game.column("player_name",anchor=CENTER,width=30)
my_game.column("player_Rank",anchor=CENTER,width=30)
my_game.column("player_states",anchor=CENTER,width=30)
my_game.column("player_city",anchor=CENTER,width=30)
