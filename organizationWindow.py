...
def run():
    ...
    l1 = Label(window, text="Название оранизация")
    l1.grid(row=0, column=0)

    l2 = Label(window, text="Тип оранизации")
    l2.grid(row=1, column=0)

    l3 = Label(window, text="id организации")
    ...
    e1 = Entry(window, textvariable=id_org_text)
    ...
    e3 = Entry(window, textvariable=ownership_text)
