...
def run():
    ...
    l2 = Label(window, text="Логин пользователя")
    l2.grid(row=1, column=0)

    l3 = Label(window, text="Пароль пользователя")
    ...
    e2 = Entry(window, textvariable=login_text)
    e2.grid(row=1, column=1)

    passwd_text = StringVar()
    e3 = Entry(window, textvariable=passwd_text)
